...
n = p.add_wrapped_text(
    4,
    "MJFAX is a text-based information service inspired by "
    "CEEFAX (see page 115). MJFAX was created by "
    "Matthew Scroggs (@mscroggs).")
n = p.add_wrapped_text(
    n + 1,
    "MJFAX uses vbit2 to encode teletext files into this "
    "television's video input.")
n = p.add_wrapped_text(
    n + 1,
    "The Python code that generates these pages can be found on "
    "GitHub at github.com/mscroggs/mathsjamfax")
...
n = p.add_wrapped_text(
    2,
    "MJFAX's source code is available at "
    "https://github.com/mscroggs/mathsjamfax")
